...
ADD_TRANS_ACTION ~TAMOKO~ BEGIN 12 14 15 END BEGIN END 
...
IF WEIGHT #-2 ~Global("X#AjantisKnowBhaalTalk","GLOBAL",1) Global("X#AjantisRomanceActive","GLOBAL",2)~ THEN BEGIN knowbhaal_lovetalk_01
SAY @0
...
SAY @39
+ ~!Class(Player1,PALADIN) Reputation(Player1,20)
Global("X#AjantisRomanceBadDecision","GLOBAL",0)~ + @40 DO ~IncrementGlobal("X#AjantisRomanceBadBhaal","GLOBAL",-1)~ + bhaalcycle_04
+ ~!Class(Player1,PALADIN) ReputationLT(Player1,20)
Global("X#AjantisRomanceBadDecision","GLOBAL",0)~ + @40 DO ~IncrementGlobal("X#AjantisRomanceBadBhaal","GLOBAL",-1)~ + bhaalcycle_05
+ ~!Class(Player1,PALADIN) GlobalGT("X#AjantisRomanceBadDecision","GLOBAL",0)~ + @40 DO ~IncrementGlobal("X#AjantisRomanceBadBhaal","GLOBAL",-1)~ + bhaalcycle_06
+ ~Class(Player1,PALADIN)~ + @40 DO ~IncrementGlobal("X#AjantisRomanceBadBhaal","GLOBAL",-1)~ + bhaalcycle_03
+ ~!Class(Player1,PALADIN) Reputation(Player1,20)
...
+ ~!Class(Player1,PALADIN) GlobalGT("X#AjantisRomanceBadDecision","GLOBAL",0)~ + @41 + bhaalcycle_06
+ ~Class(Player1,PALADIN)~ + @41 + bhaalcycle_03
++ @42 + bhaalcycle_19
++ @43 + bhaalcycle_24
...
SAY @45
IF ~!Class(Player1,PALADIN) Reputation(Player1,20)
Global("X#AjantisRomanceBadDecision","GLOBAL",0)~ THEN + bhaalcycle_21
IF ~!Class(Player1,PALADIN) ReputationLT(Player1,20)
Global("X#AjantisRomanceBadDecision","GLOBAL",0)~ THEN + bhaalcycle_22
IF ~!Class(Player1,PALADIN) GlobalGT("X#AjantisRomanceBadDecision","GLOBAL",0)~ THEN + bhaalcycle_23
IF ~Class(Player1,PALADIN)~ THEN + bhaalcycle_20
END
...
IF WEIGHT #-2 ~Global("X#AjantisKnowBhaalTalk","GLOBAL",3) Global("X#AjantisRomanceActive","GLOBAL",2)~ THEN BEGIN knowbhaal_lovetalk_02
SAY @60
...
IF WEIGHT #-2 ~Global("X#AjantisKnowBhaalTalk","GLOBAL",5) Global("X#AjantisRomanceActive","GLOBAL",2)~ THEN BEGIN knowbhaal_lovetalk_03
SAY @125
= @126
= @127
...
IF WEIGHT #-2 ~Global("X#AjantisRomanceCut","GLOBAL",1)~ THEN bhaalcycle3_15
SAY @153
...
IF WEIGHT #-2 ~Global("X#AjantisRomanceCut2","GLOBAL",1)~ THEN bhaalcycle3_16
SAY @154
...
IF WEIGHT #-2 ~Global("X#AjantisKnowBhaalTalk","GLOBAL",7) Global("X#AjantisRomanceActive","GLOBAL",2)~ THEN BEGIN knowbhaal_lovetalk_04
SAY @155
