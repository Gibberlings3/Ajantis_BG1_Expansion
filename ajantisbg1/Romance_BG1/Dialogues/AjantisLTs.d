...
/* lovetalk_motivation */
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",2)~ THEN lovetalk_motivation
SAY @0
...
+ ~Class(Player1,PALADIN)~ + @3 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + motivation_03
+ ~!Class(Player1,PALADIN)
ReputationGT(Player1,12)~ + @3 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + motivation_03

+ ~!Class(Player1,PALADIN) ReputationLT(Player1,13)~ + @3 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + motivation_04
...
+ ~Class(Player1,PALADIN)~ + @3 + motivation_03
+ ~!Class(Player1,PALADIN)
ReputationGT(Player1,12)~ + @3 + motivation_03
+ ~!Class(Player1,PALADIN) ReputationLT(Player1,13)~ + @3 + motivation_04
...
/* lovetalk_order */
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",4)~ THEN lovetalk_order
SAY @41
...
+ ~Class(Player1,PALADIN)~ + @55 + order_26
+ ~Alignment(Player1,17)
Class(Player1,FIGHTER)~ + @55 + order_26
+ ~!Alignment(Player1,17) Class(Player1,FIGHTER)~ + @55 + order_16
+ ~!Class(Player1,PALADIN) !Class(Player1,FIGHTER)~ + @55 + order_16
...
IF ~~ THEN order_06
SAY @64
IF ~Class(Player1,PALADIN)~ THEN + order_14
IF ~Alignment(Player1,17)
Class(Player1,FIGHTER)~ THEN + order_14
IF ~!Alignment(Player1,17)
Class(Player1,FIGHTER)~ THEN + order_24
IF ~!Class(Player1,PALADIN) !Class(Player1,FIGHTER)~ THEN + order_24
END
...
IF ~Alignment(Player1,17)
Class(Player1,FIGHTER)~ THEN + order_14
IF ~!Alignment(Player1,17) Class(Player1,FIGHTER)~ THEN + order_24
IF ~!Class(Player1,PALADIN) !Class(Player1,FIGHTER)~ THEN + order_24
END
...
/* Helm (LT 3) */
/* lovetalk_helm */
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",6)~ THEN lovetalk_helm
SAY @126
...
+ ~!Class(Player1,CLERIC) !Class(Player1,PALADIN)~ + @129 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + helm_12
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",8)~ THEN lovetalk_justice
SAY @187
= @188
...
/* lovetalk_evil */
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",10)~ THEN lovetalk_evil
SAY @250
...
+ ~!Class(PLayer1,Paladin)~ + @255 DO ~SetGlobal("X#AjantisRomanceEvil1","LOCALS",1) IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~  + evil_10
...
++ @300 + evil_21
+ ~!Class(PLAYER1,Paladin)~ + @301 + evil_22
END
...
/* lovetalk_waterdeep */
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",12)~ THEN lovetalk_waterdeep
SAY @311
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",14)~ THEN lovetalk_ajantisfamily
SAY @364
...
SAY @387
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceActive","GLOBAL",3) SetGlobal("X#AjantisRomanceShutUp","GLOBAL",1)~ EXIT
END
...
SAY @401
= @402
IF ~PartyHasItem("X#AJSBG1")~ THEN + ajantisfamily_12
IF ~!PartyHasItem("X#AJSBG1")~ THEN + ajantisfamily_13
END
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",16)~ THEN lovetalk_pcfamily
SAY @452
= @453
...
/* lovetalk_knight */
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",18)~ THEN lovetalk_knight
SAY @514
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",20)~ THEN lovetalk_home
SAY @558 
= @559 
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",22)~ THEN lovetalk_stars
SAY @597 
++ @598 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",23)~ + stars_25
++ @599 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",23)~ + stars_25
++ @600 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",23)~ + stars_01
++ @601 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",23)~ + stars_23
++ @602 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",23)~ + stars_24
END
...
= @672
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceActive","GLOBAL",3)
SetGlobal("X#AjantisRomanceShutUp","GLOBAL",1)~ EXIT
END
...
IF WEIGHT #-2 ~Global("X#AjantisRomanceStars","GLOBAL",3)~ THEN lovetalk_stars
SAY @675
++ @676 DO ~IncrementGlobal("X#AjantisRomanceSheHasInterest","GLOBAL",1) SetGlobal("X#AjantisRomanceStars","GLOBAL",4)~ + morning_stars_01
++ @677 DO ~SetGlobal("X#AjantisRomanceStars","GLOBAL",4)~ + morning_stars_02
END
...
IF ~~ THEN morning_stars_02
SAY @679
+ ~!Class(Player1,PALADIN)~ + @680 + morning_stars_03
+ ~!Class(Player1,PALADIN)~ + @681 + morning_stars_03
+ ~Class(Player1,PALADIN)~ + @680 + morning_stars_04
+ ~Class(Player1,PALADIN)~ + @681 + morning_stars_04
END
...
SAY @687
= @688
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceStars","GLOBAL",5)~ EXIT
END
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",24)~ THEN lovetalk_road
SAY @692
IF ~Global("X#AjantisRomanceNoRoad","GLOBAL",1)~ THEN DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",25)~ + road_01
IF ~!Global("X#AjantisRomanceNoRoad","GLOBAL",1)~ THEN DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",25)~ + road_02
END
...
++ @694 + road_03
++ @695 + road_04
+ ~Class(Player1,PALADIN)~ + @696 DO ~SetGlobal("X#AjantisRomanceOnRoad","GLOBAL",1)~ + road_07
++ @697 + road_05
++ @698 + road_21
END
...
+ ~Global("X#AjantisRomanceNoRoad","GLOBAL",1)~ + @701 + road_04
+ ~Class(Player1,PALADIN)~ + @702 DO ~SetGlobal("X#AjantisRomanceOnRoad","GLOBAL",1)~ + road_07
++ @703 + road_05
++ @704 + road_06
++ @698 + road_21
++ @705 + road_23
...
SAY @706
++ @707 + road_05
+ ~!Class(Player1,PALADIN)~ + @708 DO ~SetGlobal("X#AjantisRomanceOnRoad","GLOBAL",1)~ + road_10
+ ~Class(Player1,PALADIN)~ + @709 DO ~SetGlobal("X#AjantisRomanceOnRoad","GLOBAL",1)~ + road_07
++ @710 + road_23
END
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",26) ReputationGT(Player1,18)~ THEN lovetalk_beautiful_start1
SAY @768
++ @769 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",27)~ + beautiful_01
++ @770 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",27)~ + beautiful_02
++ @771 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",27)~ + beautiful_01
END

IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",26) ReputationLT(Player1,19)~ THEN lovetalk_beautiful_start2
SAY @772
++ @769 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",27)~ + beautiful_01
++ @770 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",27)~ + beautiful_02
++ @771 DO ~SetGlobal("X#AjantisLoveTalk","GLOBAL",27)~ + beautiful_01
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",28)~ THEN lovetalk_flowers
SAY @812 
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",30)~ THEN lovetalk_lover
SAY @853
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",32)~ THEN lovetalk_confession
SAY @1287
++ @880 DO ~SetGlobal("X#AjantisHasRing","GLOBAL",4) IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + confession_03
++ @881 DO ~SetGlobal("X#AjantisHasRing","GLOBAL",4) IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + confession_01
++ @1288 DO ~SetGlobal("X#AjantisHasRing","GLOBAL",4) IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + confession_13 
++ @1289 DO ~SetGlobal("X#AjantisHasRing","GLOBAL",4) IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + confession_02
END
...
SAY @906 
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceActive","GLOBAL",3) SetGlobal("X#AjantisRomanceOtherMan","GLOBAL",1)~ EXIT 
END
...
IF ~~ THEN confession_11
SAY @1292
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceActive","GLOBAL",2)~ EXIT
END
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",34) !Global("X#AjantisRomanceNoFlower","GLOBAL",1)~ THEN lovetalk_necklace
SAY @920
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",34) Global("X#AjantisRomanceNoFlower","GLOBAL",1)~ THEN lovetalk_necklace_2
SAY @925
++ @921 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + necklace_02
++ @922 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + necklace_02
++ @923 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + necklace_02
...
IF ~~ THEN necklace_08
SAY @941 
IF ~~ THEN DO ~GiveItemCreate("X#AJNBG1",Player1,5,1,1) SetGlobal("X#AjantisRomanceGotNecklace","GLOBAL",1)~ EXIT
END
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",36)~ THEN lovetalk_night1
SAY @942
...
//
//Talk about intimacy (LT 20) (= "night talk 2 in BGT / Tutu version)
//

IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",38)~ THEN lovetalk_night2_0
SAY @1270
= @1271
++ @1272 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + night2_01
++ @1273 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + night2_02
+ ~Global("X#AjantisRomanceWantsInt","GLOBAL",0)~ + @1274 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + night2_03
+ ~Global("X#AjantisRomanceWantsInt","GLOBAL",1)~ + @1274 DO ~IncrementGlobal("X#AjantisLoveTalk","GLOBAL",1)~ + lovetalk_night2
END

IF ~~ THEN night2_01
SAY @1275
IF ~Global("X#AjantisRomanceWantsInt","GLOBAL",0)~ THEN + night2_03
IF ~Global("X#AjantisRomanceWantsInt","GLOBAL",1)~ THEN + lovetalk_night2
END
...
IF ~~ THEN night2_11
SAY @1263
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceWantsInt","GLOBAL",2)~ EXIT
END
...
IF ~~ THEN night2_13
SAY @1023
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceWantsInt","GLOBAL",0)~ EXIT
END

IF ~~ THEN night2_14
SAY @1286
IF ~~ THEN EXIT //stays at Global("X#AjantisRomanceWantsInt","GLOBAL",1)
END
...
SAY @1264
++ @1267 DO ~SetGlobal("X#AjantisReadyForNT1","GLOBAL",4)~ + resttalk_1_0a
+ ~Global("X#AjantisRomanceWantsInt","GLOBAL",1)~ + @1268 DO ~SetGlobal("X#AjantisReadyForNT1","GLOBAL",4)~ + resttalk_1_0b
+ ~Global("X#AjantisRomanceWantsInt","GLOBAL",2)~ + @1268 DO ~SetGlobal("X#AjantisReadyForNT1","GLOBAL",4)~ + resttalk_1_0c
END

IF ~~ THEN resttalk_1_0a
SAY @1266
IF ~~ THEN DO ~SetGlobal("X#AjantisReadyForNT1","GLOBAL",0)
SetGlobalTimer("X#AjantisNT1Timer","GLOBAL",ONE_DAY)~ EXIT
END

IF ~~ THEN resttalk_1_0b
SAY @1284
++ @1281 + resttalk_1_02
++ @1282 + resttalk_1_02
++ @1019 + resttalk_1_01
...
IF ~~ THEN resttalk_1_01
SAY @1023
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceWantsInt","GLOBAL",0)~ EXIT
END

IF ~~ THEN resttalk_1_02
SAY @1283
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceIntimacy","GLOBAL",1)
...
CutSceneId(Player1)
	   ...
	   %STARTMOVIE_REST%
	   %WAIT_FADEFROMCOLOR_20%
           Wait(1)
EndCutSceneMode()
ActionOverride("ajantis",Dialogue([PC]))~ EXIT
END
...
IF WEIGHT #-2 ~Global("X#AjantisRomanceIntimacy1Morning","GLOBAL",1)~ THEN lovetalk_morning2
SAY @1036 
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",40)~ THEN lovetalk_wedding
SAY @1067
...
IF WEIGHT #-2 ~Global("X#AjantisLoveTalk","GLOBAL",42)~ THEN lovetalk_true
SAY @1138
...
++ @1160 + true_11
++ @1161 + true_11
+ ~Global("X#AjantisRomanceNoOrderMember","GLOBAL",1) Alignment(Player1,17)
Class(Player1,PALADIN)~ + @1162 + true_07
+ ~Global("X#AjantisRomanceNoOrderMember","GLOBAL",1) Alignment(Player1,17)
Class(Player1,FIGHTER)~ + @1162 + true_07

+ ~!Global("X#AjantisRomanceNoOrderMember","GLOBAL",1) Alignment(Player1,17)
Class(Player1,PALADIN)~ + @1162 + true_08
+ ~!Global("X#AjantisRomanceNoOrderMember","GLOBAL",1) Alignment(Player1,17)
Class(Player1,FIGHTER)~ + @1162 + true_08
++ @1163 + true_09
++ @1164 + true_02
END
...
IF WEIGHT #-2 ~Global("X#AjantisRomanceNight3","GLOBAL",1)~ THEN lovetalk_intimacy2
SAY @1264
++ @1267 + intimacy2_0a
++ @1268 + intimacy2_0b
END

IF ~~ THEN intimacy2_0a
SAY @1266
IF ~~ THEN DO ~SetGlobal("X#AjantisReadyForNT","GLOBAL",0)
SetGlobalTimer("X#AjantisRomance","GLOBAL",ONE_DAY)~ EXIT
END

IF ~~ THEN intimacy2_0b
SAY @1265
...
SAY @1197
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceMakeLove2","GLOBAL",1) SetGlobal("X#AjantisRomanceIntimacy","GLOBAL",1) 
...
SAY @1202
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceNoMakeLove2","GLOBAL",1) 
SetGlobal("X#AjantisRomanceIntimacy2Morning","GLOBAL",1)
ClearAllActions()
StartCutSceneMode()
CutSceneId(Player1)
...
IF WEIGHT #-2 ~Global("X#AjantisRomanceIntimacy2Morning","GLOBAL",1) Global("X#AjantisRomanceMakeLove2","GLOBAL",1)~ THEN lovetalk_morning3
SAY @1204
...
IF WEIGHT #-2 ~Global("X#AjantisRomanceIntimacy2Morning","GLOBAL",1)  Global("X#AjantisRomanceNoMakeLove2","GLOBAL",1)~ THEN lovetalk_morning3_No
SAY @1210
++ @1205 + morning3_01
+ ~!Global("X#AjantisRomanceBadInt","GLOBAL",1)~ + @1206 + morning3_02
++ @1207 + morning3_03
...
SAY @1215
= @1216
IF ~~ THEN DO ~SetGlobal("X#AjantisRomanceIntimacy2Morning","GLOBAL",2) ClearAllActions()
StartCutSceneMode()
CutSceneId(Player1)
	%FADETOCOLOR_20_WAIT%
           Rest()
...
IF WEIGHT #-2 ~Global("X#AjantisLastLoveTalk","GLOBAL",1)~ THEN lovetalk_final
SAY @1243
= @1244
++ @1245 + final_01
++ @1246 + final_02
