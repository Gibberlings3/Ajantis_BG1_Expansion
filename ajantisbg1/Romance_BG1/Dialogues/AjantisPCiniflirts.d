...
/* engaged */
IF WEIGHT #-2
~Global("C#AjantisPCIniFlirtTime","GLOBAL",1) Global("X#AjantisRomanceMatch","GLOBAL",1)
...
+ ~HasItem("X#AJNBG1",Player1) Global("X#AjantisFlirtNecklace","GLOBAL",0)~
+ @20 + flirt_necklace
+ ~HasItem("X#AJNBG1",Player1) Global("X#AjantisFlirtNecklace","GLOBAL",0)~
...
Global("X#AjantisRomanceFamilyInsult","GLOBAL",0)~ + @29 + lady_ilvastarr_01
+ ~RandomNum(3,2) Global("X#AjantisKnowBhaalTalk","GLOBAL",0)
Global("X#AjantisRomanceFamilyInsult","GLOBAL",0)~ + @29 + lady_ilvastarr_02
+ ~RandomNum(3,3) Global("X#AjantisKnowBhaalTalk","GLOBAL",0)
Global("X#AjantisRomanceFamilyInsult","GLOBAL",0)~ + @29 + lady_ilvastarr_03

+ ~RandomNum(3,1) GlobalGT("X#AjantisKnowBhaalTalk","GLOBAL",0)
Global("X#AjantisRomanceFamilyInsult","GLOBAL",0)~ + @29 + lady_ilvastarr_bhaal_01
+ ~RandomNum(3,2) GlobalGT("X#AjantisKnowBhaalTalk","GLOBAL",0)
Global("X#AjantisRomanceFamilyInsult","GLOBAL",0)~ + @29 + lady_ilvastarr_bhaal_02
+ ~RandomNum(3,3) GlobalGT("X#AjantisKnowBhaalTalk","GLOBAL",0)
Global("X#AjantisRomanceFamilyInsult","GLOBAL",0)~ + @29 + lady_ilvastarr_bhaal_03
...
//-----------------------------------------------
/* Bhaal cycle */
IF ~Global("X#AjantisRomanceMatch","GLOBAL",1)
Global("X#AjantisRomanceActive","GLOBAL",2) Global("X#AjantisRomanceThinking","GLOBAL",1) !Detect([ENEMY])
TimeOfDay(Night)
...
SAY @167
+ ~GlobalGT("X#AjantisRomanceIniFlirt","GLOBAL",2)~ + @168 + take_equipment_01
+ ~GlobalGT("X#AjantisRomanceIniFlirt","GLOBAL",2)~ + @168 + take_equipment_02
+ ~GlobalLT("X#AjantisRomanceIniFlirt","GLOBAL",3)~ + @168 + take_equipment_03
+ ~GlobalLT("X#AjantisRomanceIniFlirt","GLOBAL",3)~ + @168 + take_equipment_04
