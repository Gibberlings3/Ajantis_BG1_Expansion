...
Currently, only the Windows version of the mod exists. Currently, only the Windows version of the mod exists. Using the correct install method, it should be working on MAC OS X and Linux installs, too.
